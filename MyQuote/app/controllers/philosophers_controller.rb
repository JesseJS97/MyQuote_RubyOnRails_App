class PhilosophersController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to philosophers_path, status: :see_other, notice: "Philosopher was successfully destroyed." }
  ...
  private
    ...
    def philosopher_params
      params.require(:philosopher).permit(:p_firstName, :p_surname, :p_deathYear, :p_bio, :p_year)
    end
end
