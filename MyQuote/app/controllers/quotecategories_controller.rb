class QuotecategoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @quotecategory.save
        format.html { redirect_to @quotecategory, notice: "Quotecategory was successfully created." }
  ...
  def update
    respond_to do |format|
      if @quotecategory.update(quotecategory_params)
        format.html { redirect_to @quotecategory, notice: "Quotecategory was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to quotecategories_path, status: :see_other, notice: "Quotecategory was successfully destroyed." }
  ...
  private
    ...
    def quotecategory_params
      params.require(:quotecategory).permit(:cat_quantity, :quote_id, :category_id)
    end
end
