...
class QuotecategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quotecategory" do
    assert_difference("Quotecategory.count") do
      post quotecategories_url, params: { quotecategory: { cat_quantity: @quotecategory.cat_quantity, category_id: @quotecategory.category_id, quote_id: @quotecategory.quote_id } }
    end
  ...
  test "should update quotecategory" do
    patch quotecategory_url(@quotecategory), params: { quotecategory: { cat_quantity: @quotecategory.cat_quantity, category_id: @quotecategory.category_id, quote_id: @quotecategory.quote_id } }
